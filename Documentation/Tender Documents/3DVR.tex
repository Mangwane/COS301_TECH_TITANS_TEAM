...
\hline
 ...
 \begin{compactitem}
     ...
     \item {\large Flexible with mutliple languages ( C++, Java, Mark-up Languages and Query Languages)}
 \end{compactitem} \\ 
 \hline
 {\LARGE Past Experience} & 
 \begin{compactitem}
...
\hline
 ...
 {\LARGE Technical Skills} & 
 \begin{compactitem}
     \item {\large Programming in ( C, C++ and Java)} 
...
\paragraph{The technologies to be used for this system are:}
\begin{itemize}
\item HDK2 visual reality Glasses for rending the visual reality presentation
\item Webgl and three.js for the software that will make the presentations
\item JavaScript
\item Blender 
\end{itemize}
