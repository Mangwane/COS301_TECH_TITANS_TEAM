...
\section{Traceability Matrix}
	...
	\begin{itemize}
	\item UC1.1: Interface
	\item UC2.1: Register User
	\item UC2.2: User Login
	\item UC2.3: Delete User
	\item UC2.4: Add Student
	\item UC2.5: Delete User
	\item UC2.6: View Student
	\item UC2.7: Edit Student
	\item UC3.1: Marking Complete
	\item UC3.2: Notify Admin
	\item UC3.3: Signal System Error
	\item UC3.4: Notify Marking Status
	\item UC4.1: Get Student Results
	\item UC4.2: Stream Memo
	\item UC4.3: Encrypt
	\item UC4.4: Decrypt
	...
	\item UC5.8: Map Question Paper to Answer Sheet
	\item UC6.1: Student Progress Report
	\item UC6.2: System Report
	...
	\item R06: Output: Marked Answer Sheet
	\end{itemize}
\begin{table}[h!]
\centering
\label{my-label}
...
\hline
Requirement & Priority & \begin{tabular}[c]{@{}l@{}}UC\\ 1.1\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 2.1\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 2.2\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 3.1\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 5.1\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 5.8\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 7.1\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 7.2\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 7.3\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 7.4\end{tabular} & \begin{tabular}[c]{@{}l@{}}UC\\ 7.5\end{tabular} \\ \hline
R01 & 1 & X & X &   &   &   &   &   &   &   &   &    \\ \hline
R02 & 2 &   & X & X &   &   &   &   &   &   &   &    \\ \hline
R03 & 2 &   & X & X &   &   &   &   &   &   &   &    \\ \hline
R04 & 1 &   &   &   &   &   &   & X & X & X &   &    \\ \hline
